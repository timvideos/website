...
In that case to generate website with your changes you need to commit and push your changes to master repository (you can do it manually, use GitHub editor or Prose editor described below.

Website will be generated in 1 minute after your commit. If page generation fail, you will receive email from Travis CI.

### If you don't have ability to push to master repository

1. Fork it ( <https://github.com/timvideos/getting-started/fork> )
...
## How to add new page to getting-started?
...
Because of **Prose Content Editor** wiki part will not be longer maintained, soon wiki will contain documents related to getting-started repository: technical documentation, etc.

Editing documentation will not generate website. If you remember old headline in README, now you should learn new one:
